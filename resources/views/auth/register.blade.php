        ...
        <div class="table-base clearfix">
            <form class="clearfix" method="post" action="{{ url('register') }}">
                ...
                <div class="clearfix">
                    ...
                    <input type="password" class="password {{ $errors->has('password') ? ' is-invalid' : '' }}" name="password">
            ...
            <p style="text-align: center">{{ trans('auth.question2') }} <a href="{{ url('/login') }}"><span>{{ trans('auth.login') }}</span></a></p>
